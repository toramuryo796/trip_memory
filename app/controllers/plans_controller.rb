class PlansController < ApplicationController
  ...
  def create_plan
    params.require(:plan).permit(:title, :destination, :departure_day, :return_day, :hotel, :hotel_memo, :transportation_id, :ticket, :start_place, :candidate_id).merge(user_id: current_user.id, group_id: params[:group_id])
  end
